<?php
	...
	function lnx_PRT_display_admin_options(){
		...
		require_once(WP_PLUGIN_DIR . '/oe-phpbb-recent-topics/display/admin-options.php' );
	...
	function lnx_PRT_help($contextual_help, $screen_id, $screen) {
		...
		if ($screen_id == $lnx_PRT_admin_hook) {
			...
			$contextual_help = file_get_contents(WP_PLUGIN_DIR . '/oe-phpbb-recent-topics/display/admin-options-help.inc.php'); // the help html
		}
